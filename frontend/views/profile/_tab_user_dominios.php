...
// echo $this->render('_search', ['model' => $searchModel]); ?>
    ...
    <?php
       ...
       $query= common\models\UserSociedades::find()->andWhere(['user_id'=>$user_id]);  
        ...
        'columns' => [
                    [
                        ...
                        'value' => function ($model) {
                                return \yii\helpers\Html::checkbox('activo[]', $model->activo, ['id'=>$model->id, 'family' =>'holas','title'=>Url::to(['/profile/ajax-assign-center-user','id'=>$model->id])]);
                                },
                    ],
                ...
                [
                    ...
                    'attribute' => 'nomcen',
                        'format' => 'raw',
                        'value' => function ($model) {
                            return Html::a($model->centro->nomcen,
                ...
                'attribute' => 'despro',
                        'format' => 'raw',
                        'value' => function ($model) {
                            return $model->centro->socio->despro;
                                },
                ],
    ...
    <?php
     echo inputAjaxWidget::widget([
            ...
            //'otherContainers'=>['pjax-monto','pjax-moneda'],
             'evento'=>'click',
            'tipo'=>'POST',
            'ruta'=>Url::to(['profile/ajax-assign-all','id'=>$user_id]),
            'id_input'=>'a_id_god',
            'idGrilla'=>$zonaAjax
      ])  ?>  
    <?php
     echo inputAjaxWidget::widget([
            ...
            //'otherContainers'=>['pjax-monto','pjax-moneda'],
             'evento'=>'click',
            'tipo'=>'POST',
            'ruta'=>Url::to(['profile/ajax-revoke-all','id'=>$user_id]),
