...
$this->title = Yii::t('logi.labels', 'Menú página');
...
<div class="stock-index">
    ...
    <div class="box box-success">
     ...
     $options=['class'=>'botonAbre','data-pjax'=>'0'];
      $url= Url::to(['site/modal-crear-menu','gridName'=>'contenido-index','idModal'=>'buscarvalor']);
      ...
      [
                ...
                'buttons' => [
                       ...
                       'edit' => function ($url,$model) {
                             ...
                             $options=['class'=>'botonAbre','data-pjax'=>'0'];
			    $url= Url::to(['site/modal-editar-menu','id'=>$model->id,'gridName'=>'contenido-index','idModal'=>'buscarvalor']);
