 ...
 <div class="box box-success">
     ...
     <div class="box-header">
        ...
        <?= Html::submitButton(Yii::t('sta.labels', 'Guardar'), ['class' => 'btn btn-success']) ?>
          <?php echo  Html::button('<span class="fa fa-refresh"></span>   '.Yii::t('sta.labels', 'Generar hash'), ['id'=>'boton_hash','class' => 'btn btn-warning']);?>
...
$string5="$('#boton_hash').on( 'click', function(){ 
       $.ajax({
              url: '".\yii\helpers\Url::to(['/site/hash-user'])."', 
              type: 'get',
              dataType: 'json', 
