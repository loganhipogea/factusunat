...
$this->title = Yii::t('logi.labels', 'Noticias');
...
<div class="stock-index">
    ...
    <div class="box box-success">
     ...
     $options=['class'=>'botonAbre','data-pjax'=>'0'];
      $url= Url::to(['site/modal-crear-noticia','gridName'=>'contenido-index','idModal'=>'buscarvalor']);
      $boton= Html::a('<span class="glyphicon glyphicon-plus-sign btn btn-success"></span>', $url, $options);
     ?>
      ...
      [
                ...
                'buttons' => [
                       ...
                       'edit' => function ($url,$model) {
                             ...
                             $options=['class'=>'botonAbre','data-pjax'=>'0'];
			    $url= Url::to(['site/modal-editar-noticia','id'=>$model->id,'gridName'=>'contenido-index','idModal'=>'buscarvalor']);
         ...
         /*[
               ...
               'value' => function ($model, $key, $index, $column) {
                    ...
                    'detailUrl' =>Url::toRoute(['/site/ajax-expand-noticia']),
              ...
              ['attribute'=>'contenido',
                ...
                'value'=>function ($model){                    
                    return substr($model->contenido,0,30);
                  }
                ], 
          ...
          ['attribute'=>'activo',
                'format'=>'raw',
                'value'=>function ($model){
                    return Html::checkbox(uniqid(), $model->activo,['disabled'=>true]);
                  }
                ], 
