    ...
    <div class="box-header">
        <div class="col-md-12">
          ...
          if($model->isNewRecord){
            $url=\yii\helpers\Url::to(['/mat/activos/modal-crea-nodo','id'=>$id]);   
          }else{
             $url=\yii\helpers\Url::to(['/mat/activos/modal-edita-nodo','id'=>$id]);  
          }
          $isNew=($model->isNewRecord)?'1':'0';
          $isRoot=($id<0)?'1':'0';
          $cadData=is_null($model->id)?yii\helpers\Json::encode([]):yii\helpers\Json::encode(['id'=>$model->id]);
          //var_dump($isRoot); die();
           ?>
                  ...
                  console.log('NO es root ');
                   ...
                   if(is_new=='1'){
                    ...
                    console.log('es EDICION ');
                              ...
                              var node_editado = tree.getNodeByKey('". $model->clave."'); 
                                  console.log('". $model->clave."');
                              console.log(node_editado);
                               node_editado.setTitle('<i style=\"color:orange;\"><span class=\"fa fa-circle\"></i><span style=\"font-weight:900;\">'+codigo+'</span>-'+descripcion );
