   ...
   public $codocu='478';
    ...
    public function attributeLabels()
    {
        return [
            ...
            'codenvio' => Yii::t('base.names', 'Codenvio'),
            'fecdocu' => Yii::t('base.names', 'Fecdocu'),
            'fectran' => Yii::t('base.names', 'Fectran'),
            'codtra' => Yii::t('base.names', 'Codtra'),
            'codven' => Yii::t('base.names', 'Codven'),
            'codplaca' => Yii::t('base.names', 'Codplaca'),
            'ptopartida_id' => Yii::t('base.names', 'Ptopartida ID'),
            'ptollegada_id' => Yii::t('base.names', 'Ptollegada ID'),
            'comentario' => Yii::t('base.names', 'Comentario'),
        ];
    }
