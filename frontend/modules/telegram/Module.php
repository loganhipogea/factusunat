...
class Module extends \yii\base\Module implements \yii\base\BootstrapInterface
{
    ...
    public function init()
    {
        ...
        $this->new_options = [
            'initChat' => Url::to(['/tlbot/init-chat']),
            'destroyChat' => Url::to(['/tlbot/destroy-chat']),
            'getAllMessages' => Url::to(['/tlbot/get-all-messages']),
            'getLastMessages' => Url::to(['/tlbot/get-last-messages']),
            'initialMessage' => \Yii::t('tlgrm', 'Write your question...'),
        ];
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\console\Application) {
            $this->controllerNamespace = 'common\onmotion\telegram\commands';
        }
    }
}
