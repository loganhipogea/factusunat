...
$this->title = Yii::t('app', 'Update Cc Cc: {name}', [
    'name' => $model->id,
]);
...
<h4><i class="fa fa-edit"></i><?= Html::encode($this->title) ?></h4>
    ...
    'items' => [
        ...
        [
          'label'=>'<i class="fa fa-users"></i> '.yii::t('base.names',''), //$this->context->countDetail() obtiene el contador del detalle
