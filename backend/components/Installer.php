 ...
 */
     ...
     public static function getRutas() {
         return [
             'RBAC'=>[
        '/admin/permission/index'=>Yii::t('app', 'Permisos'),
       // '/admin/permission/create'=>Yii::t('app', 'Crear Permiso'),
         '/admin/role/index'=>Yii::t('app', 'Roles'),
        '/admin'=>Yii::t('app', 'Asignaciones'),
                 
         '/admin/rule/index'=>Yii::t('app', 'Reglas'),
       // '/admin/rule/create'=>Yii::t('app', 'Crear Regla'),
           ],
             'User'=>[
                        '/admin/user'=>Yii::t('app', 'Usuarios'),
                        '/admin/user/signup'=>Yii::t('app', 'Registrarse'),
                        //'/admin/user/request-password-reset'=>Yii::t('app', 'Solicitar'),
                        //'/admin/user/reset-password'=>Yii::t('app', 'Reset Pwd'),
                        '/admin/user/change-password'=>Yii::t('app', 'Cambiar Pass'),
                  ],
             
             'Menu'=>[
                        //'/admin/menu/create'=>Yii::t('app', 'Crear Menu'),
                        '/admin/menu/index'=>Yii::t('app', 'Menu'),
                        '/admin/route/index'=>Yii::t('app', 'Rutas'),
             ...
             //'parameters'=>[
                        ...
                        //'/parameters/index'=>Yii::t('app', 'Param Centros'),
                        //'/parameters/indexmaster'=>Yii::t('app', 'Parametros'),
                        //'/parameters/indexparamdocu'=>Yii::t('app', 'Param Docum'), 
                  //],
