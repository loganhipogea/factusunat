...
class Client extends Component
{
     ...
     */
    private $_transport = 'common\httpclient\StreamTransport';
    ...
    public function getFormatter($format)
    {
        static $defaultFormatters = [
            self::FORMAT_JSON => 'common\httpclient\JsonFormatter',
            self::FORMAT_URLENCODED => [
                'class' => 'common\httpclient\UrlEncodedFormatter',
            ...
            self::FORMAT_XML => 'common\httpclient\XmlFormatter',
            self::FORMAT_CURL => 'common\httpclient\CurlFormatter',
        ];
    ...
    public function getParser($format)
    {
        ...
        static $defaultParsers = [
            self::FORMAT_JSON => 'common\httpclient\JsonParser',
            self::FORMAT_URLENCODED => 'common\httpclient\UrlEncodedParser',
            self::FORMAT_RAW_URLENCODED => 'common\httpclient\UrlEncodedParser',
            self::FORMAT_XML => 'common\httpclient\XmlParser',
        ];
    ...
    {
        yii::error('INFGRESANDO AL A FUNCION PATCH');
