...
class Message extends Component
{
    ...
    public function getFormat()
    {
        /*yii::error('Entrando a la funcion ',__FUNCTION__);
         yii::error('IF(this->_format === null) ',__FUNCTION__);*/
        if ($this->_format === null) {
           // yii::error('cUMPLIO LA CONDICION ',__FUNCTION__);
           // var_dump("dd",$this->_format,$this->defaultFormat());die();
            //yii::error('this->_format = this->defaultFormat() ',__FUNCTION__);
            $this->_format = $this->defaultFormat();
            /* yii::error('this->_format ',__FUNCTION__);
             yii::error($this->_format  ,__FUNCTION__);*/
        }
         /* yii::error('RETIRNANDO this->_format ',__FUNCTION__);
           yii::error($this->_format  ,__FUNCTION__);*/
        return $this->_format;
    }
    ...
    {
        yii::error('Ingresando a la funcion DEFAULÑT FORMART DE MESSAGE',__FUNCTION__);
       //yii::error('retirnando Client::FORMAT_URLENCODED',__FUNCTION__);
        yii::error(Client::FORMAT_URLENCODED,__FUNCTION__);
