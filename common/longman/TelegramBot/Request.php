...
use common\longman\TelegramBot\Entities\File;
...
class Request
{
    ...
    {
        \yii::error('Ingresandso a  exceute ',__FUNCTION__);
        ...
        try {
           \yii::error('Intentando ejecutar el post request ',__FUNCTION__); 
           \yii::error('La ruta es  ',__FUNCTION__); 
           \yii::error('La ruta es  ',__FUNCTION__); 
            $response = self::$client->post(
                '/bot' . self::$telegram->getApiKey() . '/' . $action,
                $request_params
            );
             \yii::error('la respeusta es ',__FUNCTION__);
             \yii::error($response,__FUNCTION__);
        } catch (RequestException $e) {
            \yii::error('salio un Error ',__FUNCTION__);
            \yii::error($e->getMessage(),__FUNCTION__);
