...
class Telegram extends TelegramBase
{
    ...
    {
         //\yii::error('al incio La sesion 1583278999sjyre854xyw6wy7 es ',__FUNCTION__);
        //\yii::error(\yii::$app->session['ses_1583278999sjyre854xyw6wy7'],__FUNCTION__);
        $body = $this->send("/sendMessage", $params);
        $response = new Response($body);
        //\yii::error('La sesion 1583278999sjyre854xyw6wy7 es ',__FUNCTION__);
        //\yii::error(\yii::$app->session['ses_1583278999sjyre854xyw6wy7'],__FUNCTION__);
        return $response;
    }
