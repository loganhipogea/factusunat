...
abstract class BaseClient extends Component implements ClientInterface
{
     ...
     * @since 2.1
     */
    private $_httpClient = 'common\httpclient\Client';
    /**
     ...
     */
    //private $_stateStorage = 'common\authclient\SessionStateStorage';
    private $_stateStorage = 'common\models\MediaTokens';
    ...
    {
        yii::error('colocando el set ',__FUNCTION__);
        yii::error($this->getStateStorage(),__FUNCTION__);
